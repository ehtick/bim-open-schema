...
// Named-column BOS decoding adapted from DataModel.IO/BosReader; this path receives prepared arrays only.
[Impure]
internal static class SourceColumnDecoder
{
    internal static BimData Decode(Dictionary<string, Dictionary<string, Array>> tables, Manifest manifest)
    {
